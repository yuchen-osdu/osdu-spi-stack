...
- **Managed Istio** from the selected AKS mode (ADR-031). Provides the Gateway
...
- [ADR-031](../decisions/031-selectable-aks-deployment-modes.md) -- selected AKS mode and managed Istio
