...
@description('Availability zones for the system node pool. The CLI resolves the zones this VM size can actually use in the target region, because zone restrictions are per subscription.')
